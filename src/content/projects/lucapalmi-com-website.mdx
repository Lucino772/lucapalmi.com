import thumbnail from "@/content/images/website/cover.png";
import vercel from "@/content/images/technologies/vercel.png";
import tailwind from "@/content/images/technologies/tailwind.png";
import nextjs from "@/content/images/technologies/nextjs.png";
import contentful from "@/content/images/technologies/contentful.png";

export const metadata = {
    title: "lucapalmi.com website",
    github: "https://github.com/Lucino772/lucapalmi.com",
    website: "https://lucapalmi.com",
    thumbnail: thumbnail,
    description:
        "This project is the website your currently on. It's a simple static website build with Next.js. It's serve as a portfolio to showcase projects I made.",
    technologies: [
        {
            name: "Vercel",
            slug: "vercel",
