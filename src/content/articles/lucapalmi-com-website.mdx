...
export const metadata = {
    title: "Case Study: Personal Website",
    subtitle:
        "A static website build with Next.js. It serve as a portfolio to showcase my work.",
    createdAt: new Date(2025, 10, 14),
    tags: ["Case Study", "Vercel", "Tailwind", "Next.js", "Contentful"],
    readingTime: 4 * 60,
    cover: {
        data: thumbnail,
        kind: "internal",
